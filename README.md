...
Polishes drafts into clear, powerful, and rhythmically strong articles suitable for mass communication (C-end blogs, deep articles), following William Zinsser's philosophy.
...
```bash
gemini skills install ./content-polisher
```
